    ...
    private void Change(SimpleCursorAdapter adapter){
        adapter.setViewBinder(new SimpleCursorAdapter.ViewBinder() {
            ...
            public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
                if(cursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_CREATE_DATE) == columnIndex
                        || cursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE) == columnIndex){
                    TextView textView = (TextView)view;
                    //Long s = cursor.getLong(columnIndex);
                    //Log.d("dd",String.valueOf(s));
        ...
        */
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                String seletion = NotePad.Notes.COLUMN_NAME_TITLE + " like ? ";
